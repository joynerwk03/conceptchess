...
POINTS = [
    ...
    # session 10: SEE ordering gate +53 (60 games vs s9 core)
    {"label": "session 10 — SEE capture ordering (+53)", "exps": 97,
     "elo": CC + 53, "lo": CC + 53 - CHAIN_ERR, "hi": CC + 53 + CHAIN_ERR,
     "kind": "chained"},
    # session 11: countermove/malus (+35) + byte-identical -21% speed batch;
    ...
    # session 15: improving heuristic (+53), qsearch TT probe (+35);
    # anchored (30 games vs SF2600-3000) — held SF3000 to 7 draws
    {"label": "session 15 — improving + qsearch TT", "exps": 135,
     "elo": S15, "lo": S15_LO, "hi": S15_HI, "kind": "measured"},
    # session 16: Texel-XL outcome tuning at 59k samples (+53 gate);
    ...
    # session 18: mop-up +29; deep-TC +223 @1s validated; winner's-curse
...
<div class="elo-root">
  ...
  scale at 0.3s/move (compiled C core; 30 ladder games vs SF 2400–2800). Filled points are direct ladder anchors;
